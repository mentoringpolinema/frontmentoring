...
(function(z) {
    ...
    try {
        ...
        var U = {
                ...
                // "default-branding": '<span class="thin">We\'re</span> <img class="emojione" alt="\u26a1" title=":zap:" src="https://cdn.jsdelivr.net/emojione/assets/png/26a1.png?v=2.2.7"> by <b>Mentoring Polinema</b>',
            ...
            handleAcknowledgment: function(a) {
                ...
                if (e && a.messageId && (b = e.getElementById(a.messageId))) {
                    ...
                    if (x && x.length && E && E.length)
                        ...
                        } else h = d.chatHandler.messages[a.order], d.viewHandler.addWaitTime(), g.removeChild(b), d.chatHandler.prepareMessage(h,
                            !0, !1, !0)
                }
            },
        ...
        var ka = X.extend({
            ...
            insertFrameStyle: function() {
                ...
                this.iframeContainer.insertCssFile(a,
                    !0)
            },
            show: function() {
                q.hide();
        ...
        var ub = ka.extend({
            ...
            handleEndChat: function() {
                ...
                f.isEmbedded || (f.isPopup ? (d.socketManager.sendToConnector("popupOnFocus",
