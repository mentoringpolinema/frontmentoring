(function(global) {
    global.$_Tawk_AccountKey = '60a304b1b1d5182476b9cbd3';
    global.$_Tawk_WidgetId = '1f5ucklnn';
    ...
    (function(b) {
        ...
        a.form.visitButton = {
            message: "Visit mentoringpolinema.my.id"
        };
        ...
        a.overlay.tawkContent = {
            message: "Dikelola oleh Panitia Mentoring 2021 - Ehey."
        };
        a.chat = {};
        a.chat.visitor_name = {
        ...
        a.chat.we_are_live = {
            message: "Yauda, Chat aja. tinggal ngirim doang kok :)."
        };
    ...
    (function(b) {
        function c() {
            ...
            a.async = !0;
            a.src = "template/tawkto.js/tawktos.js";
            a.charset = "UTF-8";
