                                            ...
                                            <div class="data">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        ...
                                                        <h4 class="title"><span
                                                                class="name">Nama : {{$data_mentee->nama_mentee}} </span>
                                                            <span
                                                                class="badge badge-dim badge-success badge-pill">{{auth()->user()->role}}</span>
                                                        </h4>
                                                        <div class="meta">
                                                                <span class="version">
                                                                    <span
                                                                        class="text-soft">Email : {{auth()->user()->email}}</span>
                                                                </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-inner border-bottom">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h6 class="title"><span><em class="icon ni ni-clock-fill"></em></span>
                                                            Timeline Mentoring <?php echo date("Y");?></h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-inner">
                                                    ...
                                                    <ul class="timeline-list">
                                                        @foreach ($data_kegiatan as $kegiatan)
                                                            <li class="timeline-item">
                                                                <div
                                                                    class="timeline-status bg-success is-outline"></div>
                                                                <div
                                                                    class="timeline-date">{{$kegiatan->tanggal_kegiatan->format('d M Y')}}</div>
                                    ...
                                    <div class="col-lg-6 col-xxl-4">
                                        <div class="card h-100 ">
                                            <div class="card-inner border-bottom">
                                                <div class="card-title-group">
                                                    <div class="card-title">
                                                        <h6 class="title"><span><em
                                                                    class="icon ni ni-notify"></em></span> Pengumuman
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="nk-support-content">
                                                            <div class="title">
                                                                ...
                                                                @if($pengumuman->status_pengumuman == 'Selesai')
                                                                    <span
                                                                        class="badge badge-dot badge-dot-xs badge-success ml-1">Selesai</span>
                                                                @endif
                                                                @if($pengumuman->status_pengumuman == 'On Going')
                                                                    <span
                                                                        class="badge badge-dot badge-dot-xs badge-dark ml-1">On Going</span>
                                                                @endif
