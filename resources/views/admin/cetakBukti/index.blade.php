                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col tb-col-lg">
                                                <a href="/admin/cetak/detail/{{$cetak->id_cetak}}"><button class="btn btn-sm btn-primary"><em class="icon ni ni-eye"></em></button></a>
                                                @if ($cetak->status_cetak == 'Pending')
                                                    <form action="/admin/cetak/acc/{{$cetak->id_cetak}}" method="POST"> 
                                                    @csrf 
                                                    <button type="submit" class="btn btn-sm btn-success"><em class="icon ni ni-check"></em></button>
                                                </form>
                                                @endif
                                                <a href="/admin/cetak/delete/{{$cetak->id_cetak}}"><button class="btn btn-sm btn-danger"><em class="icon ni ni-trash"></em></button></a>
                                            </td>
                                        </tr><!-- .nk-tb-item  -->
                                        @endforeach
                                    </tbody>
